...
const int rHighTurnPwr = 176, rLowTurnPwr = 163;
const int lHighTurnPwr = 176, lLowTurnPwr = 163;
...
void executeCommands()
{
  ...
  else
  {
    ...
    while (command)
    {
      ...
      {
        motorController.turnDeg(value, lLowTurnPwr, lHighTurnPwr);
      }
      else if (argument == 'R')
      {
        motorController.turnDeg(-value, rHighTurnPwr, rLowTurnPwr);
      }
      else if (argument == 'B')
      {
